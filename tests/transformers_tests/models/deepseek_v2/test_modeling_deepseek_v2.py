...
"""Testing suite for the Mindspore DeepSeekV2 model."""
import inspect

import numpy as np
import pytest
import torch
from transformers.models.deepseek_v2.modeling_deepseek_v2 import DeepseekV2Model,DeepseekV2ForCausalLM,DeepseekV2ForSequenceClassification
...
DEEPSEEKV2_CASES = [
    [
        ...
        (),
        {
            "inputs_id": inputs_dict["inputs_id"],
