...
"""Testing suite for the Mindspore GraniteMoeShared model."""
...
model_tester = GraniteMoeSharedModelTester()
(
    config,
    input_ids,
    input_mask,
...
GEMMA2_CASES = [
    [
        ...
        "mindone.transformers.Gemma2Model",
        (config,),
        {},
        (input_ids,),
        {
